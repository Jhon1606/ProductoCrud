...
class producto extends conexion{
    ...
    public function add($codigo,$nombre,$fecha_creacion,$precio_costo,$precio_venta){
    $statement=$this->conexion->prepare("INSERT INTO inventario (codigo,nombre,fecha_creacion,precio_costo,precio_venta)
                                        VALUES(:codigo,:nombre,:fecha_creacion,:precio_costo,:precio_venta)");
